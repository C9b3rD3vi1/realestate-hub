...
SECRET_KEY = 'django-insecure-+!-7fha4#m%d!w*1@o7=@dz!anzkoe9f@k&6azj$7*5st)&lz$'
...
'''
DATABASES = {
    'default': dj_database_url.config(default=os.getenv("INTERNAL_DATABASE_URL"))
}'''
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "Digital Catalyst Admin",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "Digital Catalyst",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "Digital Catalyst",
    ...
    "welcome_sign": "Digital Catalyst",

    # Copyright on the footer
    "copyright": "Digital Catalyst",
